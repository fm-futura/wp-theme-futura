...
function bones_excerpt_more($more) {
	...
	return '...  <a href="'. get_permalink($post->ID) . '" class="more-link" title="Read '.get_the_title($post->ID).'">'.__("Read more &raquo;","bonestheme").'</a>';
}
...
function bones_theme_support() {
	...
	register_nav_menus(                      // wp3+ menus
		array( 
			'main_nav' => 'Secciones',   // main nav in header
			'footer_links' => 'La Radio' // secondary nav in footer
		)
	);	
}
...
function page_navi($before = '', $after = '') {
	...
	else { echo '<li class="disabled"><a href="#">&larr; Anteriores</a></li>'; }
	...
	echo '<li class="">';
	next_posts_link('Siguientes &rarr;');
	echo '</li>';
	if ($end_page < $max_page) {
