...
// Widgets
require_once('widgets/registerWidgets.php');
...
function getTimThumbUrl($src, $sizeType,$crop,$height,$width) {
    $size;
    if( $crop == '' ){
        $crop = 2;
    }
    switch ($sizeType) {
        case 'futura-featured-big';
            $size[0] = 850;
            $size[1] = 400;
            break;
        case 'futura-featured-small';
            $size[0] = 448;
            $size[1] = 400;
            break;
        case 'futura-nota-home';
            $size[0] = 622;
            $size[1] = 300;
            break;
        case 'custom';
    ...
    return get_template_directory_uri() . '/libs/timthumb.php?src=' . $src . '&h=' . $size[1] . '&w=' . $size[0] . '&zc='.$crop.'&cc=#f2f2f2';
}

add_image_size('futura-featured-big', 473, 200, true);
add_image_size('futura-featured-small', 224, 200, true);
add_image_size('futura-nota-home', 311, 150, true);
...
// enqueue styles
    if (!function_exists("theme_styles")) {
        ...
        function theme_styles() {
            ...
            wp_register_style('mosaic', get_template_directory_uri() . '/library/css/mosaic.css', array(), '1.0', 'all');
...
// enqueue javascript
    if (!function_exists("theme_js")) {
        ...
        function theme_js() {
            ...
            /* wp_register_script(  'jquery-old', 
              get_template_directory_uri() . '/library/js/libs/jquery-1.7.1.min.js',
              array(),
              '1.2' ); */
            wp_register_script('mosaic', get_template_directory_uri() . '/library/js/mosaic.1.0.1.min.js', array('jquery'), '1.2');
            ...
            wp_register_script('carousel', get_template_directory_uri() . '/library/js/responsiveCarousel.min.js', array('jquery'), '1.2');            
...
// THIS INCLUDES THE THUMBNAIL IN OUR RSS FEED
    function insertThumbnailRSS($content) {
        ...
        if (has_post_thumbnail($post->ID)) {
            $content = '' . get_the_post_thumbnail($post->ID, 'futura-nota-home') . '' . $content;
        }
        return $content;
    }
    ...
    /*
     * INCLUDE SHORTCODES REGISTRATION
     */
    include('RegisterShortCodes.php');
    /*
 * INCLUDE SHORTCODES REGISTRATION
 */
